		...
		<>
			<div style={{ scrollBehavior: "smooth" }}>
                ...
                >
                    ...
                    >
                        {/* Section 1: Church Description */}
                        <div style={{ color: "#fff", fontSize: "1.1rem", fontWeight: 500, textShadow: "0 1px 8px #000", textAlign: "center", marginBottom: 0 }}>
                            <p>
                                <strong>Crosslife Christian Fellowship</strong> is the adult, English-speaking, congregation of Gardena Presbyterian Church (PCA). As a diverse community of believers, Crosslife's purpose is to reflect the differences that become united in Christ, by reaching out with the gospel to the South Bay.
                            </p>
                        </div>
                        {/* Section 2: Service Info */}
                        <div style={{ fontSize: "1.1rem", fontWeight: 500, color: "#fff", textAlign: "center", marginBottom: 0 }}>
                            <p style={{ marginBottom: 0 }}>
                                <strong>Sunday Service: 11:30 AM</strong><br />
                                1340 W Gardena Blvd <br />
                                Gardena, CA 90247
                            </p>
                        </div>
                        {/* Section 3: Google Map */}
                        <div style={{ width: "100%", maxWidth: 400, borderRadius: 8, overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.5)", height: "180px", margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                            <iframe
                            ...
                            <a
                                ...
                                style={{ display: "block", color: "#bb86fc", textDecoration: "underline", fontSize: 14, marginTop: 4, textAlign: "center" }}
                            >
                                View on Google Maps
                            </a>
                        </div>
